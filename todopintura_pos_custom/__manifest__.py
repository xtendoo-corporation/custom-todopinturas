# -*- coding: utf-8 -*-
{
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            ...
            'todopintura_pos_custom/static/src/js/orderline.js',
            'todopintura_pos_custom/static/src/xml/orderline.xml',
            'todopintura_pos_custom/static/src/js/location_line_dialog.js',
            'todopintura_pos_custom/static/src/xml/location_line_dialog.xml',
            'todopintura_pos_custom/static/src/js/pos_order_line.js',
        ],
    },
    'license': 'LGPL-3',
}
