# -*- coding: utf-8 -*-
{
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            ...
            'todopintura_pos_line_ubication/static/src/js/ubication_button.js',
            'todopintura_pos_line_ubication/static/src/js/action_pad.js',
            'todopintura_pos_line_ubication/static/src/xml/action_pad.xml',
            'todopintura_pos_line_ubication/static/src/js/location_selection_dialog.js',
            'todopintura_pos_line_ubication/static/src/xml/location_selection_dialog.xml',
            ...
            'todopintura_pos_line_ubication/static/src/js/orderline_wrapper.js',
